...
if (!keySource) {
    logger.error('FATAL: CRYPTO_KEY environment variable is not set. Encryption will be insecure. Please set a strong secret in your .env file.');
}
...
export const cryptoService = {
    ...
    decrypt(text) {
        ...
        try {
            ...
            logger.error('Decryption failed for text:', text.substring(0, 10) + '...');
