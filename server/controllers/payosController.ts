...
export const payosController = {
    ...
    async createPaymentLink(req: Request, res: Response) {
        try {
            ...
            res.status(500).json({ message: (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? error.message : String(error)) : String(error)) : String(error)) : String(error)) : String(error)) : String(error)) || 'Không thể tạo link thanh toán.' });
        }
    },
     ...
     */
    async createDonationLink(req: Request, res: Response) {
        try {
            ...
            logger.error('PayOS create donation link error:', error);
            res.status(500).json({ message: (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? error.message : String(error)) : String(error)) : String(error)) : String(error)) : String(error)) : String(error)) || 'Không thể tạo link quyên góp.' });
        }
    },
    ...
    async verifyPayment(req: Request, res: Response) {
        try {
            ...
            try {
                ...
                logger.error('Error calling PayOS API:', err);
            ...
            logger.error('PayOS verify order error:', error);
            res.status(500).json({ message: (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? error.message : String(error)) : String(error)) : String(error)) : String(error)) : String(error)) : String(error)) || 'Error verifying order.' });
        }
    }
};
